        ...
        return {
            ...
            s_external_link: {
                markdown_css: function() {
                    return 'https://dl.gamdream.com/ids_cloud_platform/css/github-markdown.min.css';
                },
                hljs_js: function() {
                    return 'https://dl.gamdream.com/ids_cloud_platform/js/highlight.min.js';
                },
                hljs_lang: function(lang) {
                    return 'https://dl.gamdream.com/ids_cloud_platform/js/' + lang + '.min.js';
                },
                hljs_css: function(css) {
                    if (hljsCss[css]) {
                        return 'https://dl.gamdream.com/ids_cloud_platform/css/' + css + '.min.css';
                    }
                    return '';
                },
                katex_js: function() {
                    return 'https://dl.gamdream.com/ids_cloud_platform/js/katex.min.js';
                },
                katex_css: function() {
                    return 'https://dl.gamdream.com/ids_cloud_platform/css/katex.min.css';
                }
            },
            p_external_link: {},
